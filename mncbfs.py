...
M,C=[int(x) for x in input("Enter no. of missionaries and Cannibals: ").split()]
...
def mnc():
  ...
  while open:   #while open list is not empty
    ...
    open.extend(templist)   # inserting at the front; depth first
